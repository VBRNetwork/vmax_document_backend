...
schema_view = get_schema_view(
    openapi.Info(
        title="VBRLabs Contract Manager API",
        default_version="v1",
        description="This is VBRLabs Contract Manager API",
...
urlpatterns = [
    ...
    path("api/manage-company/", include("companymanager.urls")),
...
admin.site.site_header = "VBRLabs Admin Portal"
admin.site.site_title = "VBRLabs Admin Portal"
admin.site.index_title = (
    'Welcome to VBRLabs Admin for Document Manager' 
)